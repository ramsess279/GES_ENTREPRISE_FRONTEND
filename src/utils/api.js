...
// Configuration de base d'Axios avec l'URL du backend déployé
const API_BASE_URL = process.env.REACT_APP_API_URL || 'https://ges-entreprise-backend-1.onrender.com/api';
